...
<html <?php language_attributes(); ?> class="no-js">
    ...
    <div class="container">
			...
			<div class="site-logo-wrapper">
				...
				<div class="site-logo">
					<a href="/">
						<img class="logo-mark" src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-mark-dark.png" alt="Site logo">
            <img class="logo-type" src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-type-dark.svg" alt="Finca Luna Nueva Lodge">
          </a>
				</div>
			</div>
		</div>
