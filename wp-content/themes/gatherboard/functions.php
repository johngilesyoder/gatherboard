...
function html5blank_header_scripts() {
  if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    ...
    wp_register_script('site', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.4/jquery.min.js', array(), null, false);
    wp_enqueue_script('site'); // Enqueue it!

    wp_register_script('bootstrap', get_template_directory_uri() . '/assets/js/lib/bootstrap.min.js', array(), null, false);
    wp_enqueue_script('bootstrap'); // Enqueue it!

    wp_register_script('app', get_template_directory_uri() . '/assets/js/scripts.js', array(), null, true); // Home scripts
...
function html5blank_styles() {
  ...
  wp_register_style('google-fonts', 'https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700|Roboto:300,400,400i,500,700', array(), '1.0', 'all');
  wp_enqueue_style('google-fonts'); // Enqueue it!


  wp_register_style('material-design-icons', 'https://cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css', array(), '1.0', 'all');
  wp_enqueue_style('material-design-icons'); // Enqueue it!
